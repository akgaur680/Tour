const transactionColumn = [
    ...
    },
    {
        ...
        searchable: false,
        render: function (data, type, row) {
            return `<button type="button" onclick="viewTransaction(event,${row.id})" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></button>`;
        }
    }
    ];

InitializeTable('transactionTable', '/admin/transactions', transactionColumn);
