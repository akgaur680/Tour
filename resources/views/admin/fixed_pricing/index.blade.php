    ...
    <div class="card w-75 text-center m-auto">
        <div class="card-body">
            <div class="row d-flex justify-content-between m-2 w-25">
                ...
                <button class="btn btn-outline-success" onclick="showForm(event, 'addPricingDiv', 'pricing', 'store', 'Add New Tour Pricing', 'Save Pricing')">Add Pricing</button>

            </div>
            <!-- Add / Update Car -->
            <div class="modal" id="addPricingDiv" style="display: none;">
                <div class="card modal-content">
                    <h2 class="card-title mt-2" id="card-title">
                        <span id="car-title"></span>
                        <button type="button" class="close m-3" aria-label="Close" onclick="closeDiv(event, 'addPricingDiv')">
